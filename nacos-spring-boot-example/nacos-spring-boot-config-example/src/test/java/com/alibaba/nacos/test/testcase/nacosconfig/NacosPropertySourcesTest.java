...
@NacosPropertySources({
    @NacosPropertySource(dataId = "com.alibaba.nacos.example.properties", autoRefreshed = false),
    @NacosPropertySource(dataId = "com.alibaba.nacos.test.properties", autoRefreshed = false, before = SYSTEM_ENVIRONMENT_PROPERTY_SOURCE_NAME)}
)
public class NacosPropertySourcesTest extends BaseTestCase {
